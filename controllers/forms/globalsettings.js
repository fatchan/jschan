...
module.exports = async (req, res, next) => {
	...
	const schema = [
		...
		{ result: minmaxBody(req.body.global_limits_thread_limit_min, req.body.global_limits_thread_limit_max), expected: false, error: 'Global thread limit min must be less than max' },
		...
		{ result: minmaxBody(req.body.global_limits_reply_limit_min, req.body.global_limits_reply_limit_max), expected: false, error: 'Global reply limit min must be less than max' },
		...
		{ result: minmaxBody(req.body.global_limits_bump_limit_min, req.body.global_limits_bump_limit_max), expected: false, error: 'Global bump limit min must be less than max' },
