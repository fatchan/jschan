...
module.exports = {
	...
	addNftRuleController: require(__dirname+'/addnftrule.js'),
	editNftRuleController: require(__dirname+'/editnftrule.js'),
	deleteNftRuleController: require(__dirname+'/deletenftrule.js'),
