...
const Metadata = Object.seal(Object.freeze(Object.preventExtensions({
	...
	[Permissions.MANAGE_BOARD_STAFF]: { label: 'Staff', desc: 'Access to staff management, and ability to add or remove permissions from others. Can only be given by somebody else with "Board Owner" permission. Use with caution!', parents: [Permissions.MANAGE_BOARD_OWNER] },
