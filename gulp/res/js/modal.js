...
if (data.redirect && data.title.toLowerCase() === 'success') {
pug_html = pug_html + "\u003Cdiv class=\"row\"\u003E\u003Ca" + (" class=\"button mv-0\""+pug_attr("href", data.redirect, true, false)) + "\u003EContinue\u003C\u002Fa\u003E\u003C\u002Fdiv\u003E";
}
else
if (data.settings) {
